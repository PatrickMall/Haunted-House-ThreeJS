...
const graveGeometry = new THREE.BoxGeometry(0.9, 0.8, 0.2)
...
for (let i = 0; i < 50; i++) {
    ...
    fontLoader.load('fonts/helvetiker_regular.typeface.json',
        (font) => {
            ...
            const name = new THREE.Mesh(textGeometry, textMaterial)
            name.position.set(x, 0.5, z + 0.05)
            name.rotation.y = grave.rotation.y
            name.rotation.z = grave.rotation.z
            graves.add(name)
